...
public class InterfaceInfoController {
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        ClientXingchen tempClient = new ClientXingchen(accessKey, secretKey);
        Gson gson = new Gson();
        com.xingchen.sdkxingchen.model.User user = gson.fromJson(userRequestParams, com.xingchen.sdkxingchen.model.User.class);
